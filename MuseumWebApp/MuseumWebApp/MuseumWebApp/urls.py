...
urlpatterns = [
    ...
    re_path(r'^home/excursion_detail/(?P<id>\d+)/$', views.excursion_detail, name='excursion_detail'),
    re_path(r'^home/exhibition_detail/(?P<id>\d+)/$', views.exhibition_detail, name='exhibition_detail'),
    re_path(r'^home/add_to_cart_excursion/(?P<id>\d+)/$', views.add_to_cart_excursion, name='add_to_cart_excursion'),
    re_path(r'^home/add_to_cart_exhibition/(?P<id>\d+)/$', views.add_to_cart_exhibition, name='add_to_cart_exhibition'),
    re_path(r'^faq/delete_FAQ/(?P<id>\d+)/$', views.delete_FAQ, name='delete_faq'),
    re_path(r'^contact/$', views.contact, name='contact'),
    re_path(r'^graphics/$', views.graphics, name='graphics'),
    re_path(r'^toys_shop_prototypical/$', views.toys_shop_prototypical, name='toys_shop_prototypical'),
    re_path(r'^toys_shop_class/$', views.toys_shop_class, name='toys_shop_class'),
    re_path(r'^add_employee/$', views.add_employee, name='add_employee'),
    re_path(r'^api/employees/$', views.employee_list_api, name='employee_list_api'),
    ...
    re_path(r'^my_cart/$', views.my_cart, name='my_cart'),
    re_path(r'^contacts_table/$', views.contacts_table, name='contacts_table'),
    re_path(r'^my_cart/pay_page/(?P<item_id>\d+)/$', views.pay_page, name='pay_page'),
    re_path(r'^my_cart/process_payment/(?P<item_id>\d+)/$', views.process_payment, name='process_payment'),
    re_path(r'^my_cart/remove_from_cart/(?P<item_id>\d+)/$', views.remove_from_cart, name='remove_from_cart'),
    re_path(r'^my_cart/decrease_quantity/(?P<item_id>\d+)/$', views.decrease_quantity, name='decrease_quantity'),
    re_path(r'^my_cart/increase_quantity/(?P<item_id>\d+)/$', views.increase_quantity, name='increase_quantity'),
